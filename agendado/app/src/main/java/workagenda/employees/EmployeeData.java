...
public class EmployeeData extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        SQLiteDatabase db = (new DataBaseOperator(this)).getWritableDatabase();
    ...
    public void onListItemClick(ListView parent, View view, int position, long id) {
	    ...
	    switch (action.getType()) {
	    	...
	    	case EmployeeAction.ACTION_VIEW:
	        	intent = new Intent(this, EmployeeData.class);
    ...
    class EmployeeActionAdapter extends ArrayAdapter<EmployeeAction> {
    	...
    	EmployeeActionAdapter() {
			super(EmployeeData.this, R.layout.action_list_item, actions);
		}
